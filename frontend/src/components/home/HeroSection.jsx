...
export const HeroSection = ({ heading }) => {
  return (
    ...
    >
      ...
      <div className="relative px-6 md:px-8 lg:px-0 lg:py-10">
        <div className="flex flex-col gap-x-16 gap-y-18 lg:flex-row">
          <SectionBackground variant="left" className="ml-5 border-r-0 lg:block hidden md:rounded-none lg:rounded-l-4xl" />
